import svgPaths from "./svg-tkfgqi6vnx";
  ...
  return (
    <div className="relative shrink-0 size-[16px]" data-name="document--pdf 1">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_2010_5302)" id="document--pdf 1">
...
function VehicleHandback() {
  return (
    <div className="absolute bg-white h-[932px] left-[calc(100%+425px)] overflow-clip top-[86px] w-[430px]" data-name="Vehicle Handback">
      <StatusBar />
      <HomeBar />
      <Frame12 />
      <Frame555 />
...
function Button3() {
  return (
    <div className="bg-[#c6c6c6] box-border content-stretch flex h-[40px] items-center justify-between overflow-clip px-[20px] py-0 relative shrink-0 w-[147px]" data-name="Button">
      <p className="[white-space-collapse:collapse] font-['IBM_Plex_Sans:Regular',_sans-serif] leading-[normal] not-italic overflow-ellipsis overflow-hidden relative shrink-0 text-[#8d8d8d] text-[14px] text-nowrap w-[109px]">Submit</p>
      <CheckmarkFilled1 />
    </div>
  );
}
...
function TopActionBar() {
  return (
    <div className="absolute bg-[#eef0f8] box-border content-stretch flex gap-[10px] h-[50px] items-center left-0 overflow-clip px-[20px] py-[10px] top-[320px] w-[430px]" data-name="TopActionBar">
      <Frame903 />
    </div>
  );
}
...
export default function NewPartsRelocation1() {
  return (
    <div className="bg-white relative size-full" data-name="New Parts Relocation 1">
      <StatusBar1 />
      <HomeBar1 />
      <VehicleHandback />
      <BottomBar />

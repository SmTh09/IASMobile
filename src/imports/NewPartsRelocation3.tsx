import svgPaths from "./svg-f2hc9sdtzn";
...
function Frame1146() {
  return (
    <div className="absolute box-border content-stretch flex flex-col gap-[10px] items-start left-0 p-[20px] top-[320px] w-[430px]">
      <PartCard />
    </div>
  );
}
...
export default function NewPartsRelocation3() {
  return (
    <div className="bg-white relative size-full" data-name="New Parts Relocation3">
      <StatusBar1 />
      <HomeBar1 />
      <VehicleHandback />
      <BottomBar />

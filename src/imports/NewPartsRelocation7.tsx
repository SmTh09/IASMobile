import svgPaths from "./svg-f7r5425m3z";
  ...
  return (
    <div className="absolute left-[332px] size-[32px] top-[7px]" data-name="search 1">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32 32">
        <g clipPath="url(#clip0_4003_1162)" id="search 1">
...
function Menu1() {
  return (
    <div className="absolute left-0 size-[32px] top-[7px]" data-name="menu 1">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32 32">
        <g clipPath="url(#clip0_4003_1191)" id="menu 1">
  ...
  return (
    <div className="relative shrink-0 size-[16px]" data-name="document--pdf 1">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_4003_1106)" id="document--pdf 1">
...
function ArrowRight2() {
  return (
    <div className="relative size-[16px]" data-name="arrow--right 2">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_4003_1158)" id="arrow--right 2">
          <path d={svgPaths.pfec3600} fill="var(--fill-0, white)" id="Vector" />
          <g id="<Transparent Rectangle>"></g>
        </g>
        <defs>
          <clipPath id="clip0_4003_1158">
            <rect fill="white" height="16" width="16" />
          </clipPath>
        </defs>
      </svg>
...
function CheckmarkFilled1() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="checkmark--filled 1">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_4003_1153)" id="checkmark--filled 1">
...
function TrashCan1() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="trash-can 1">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_4003_1174)" id="trash-can 1">
...
function Frame1146() {
  return (
    <div className="absolute box-border content-stretch flex flex-col gap-[10px] items-start left-0 p-[20px] top-[254px] w-[430px]">
      <PartCard />
    </div>
  );
}
...
export default function NewPartsRelocation7() {
  return (
    <div className="bg-white relative size-full" data-name="New Parts Relocation 7">
      <StatusBar1 />
      <HomeBar1 />
      <VehicleHandback />
      <BottomBar />

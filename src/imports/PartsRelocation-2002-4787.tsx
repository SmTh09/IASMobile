import svgPaths from "./svg-63jr8qra3z";
...
function AddAlt2() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="add--alt 2">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_2002_649)" id="add--alt 2">
...
function NotFound() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[10px] h-[82px] items-center justify-center left-[calc(20%+39px)] top-[425px]" data-name="Not Found">
      <Search1 />
...
function Tab() {
  return (
    <div className="box-border content-stretch flex gap-[10px] items-center justify-center pb-[20px] pt-0 px-0 relative shrink-0" data-name="Tab">
      ...
      <p className="font-['IBM_Plex_Sans:Regular',_sans-serif] leading-[normal] not-italic relative shrink-0 text-[#161616] text-[14px] text-nowrap whitespace-pre">All</p>
    </div>
  );
}
...
function Tab2() {
  return (
    <div className="box-border content-stretch flex gap-[10px] items-center justify-center pb-[20px] pt-0 px-0 relative shrink-0" data-name="Tab">
      <p className="font-['IBM_Plex_Sans:Regular',_sans-serif] leading-[normal] not-italic relative shrink-0 text-[#161616] text-[14px] text-nowrap whitespace-pre">Acepted</p>
    </div>
  );
}

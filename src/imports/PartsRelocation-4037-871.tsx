import svgPaths from "./svg-q8xuxl36tp";
...
function Tab() {
  return (
    <div className="box-border content-stretch flex gap-[10px] items-center justify-center pb-[20px] pt-0 px-0 relative shrink-0" data-name="Tab">
      <div aria-hidden="true" className="absolute border-[#4c68b0] border-[0px_0px_3px] border-solid inset-0 pointer-events-none" />
      <p className="font-['IBM_Plex_Sans:Regular',_sans-serif] leading-[normal] not-italic relative shrink-0 text-[#161616] text-[14px] text-nowrap whitespace-pre">Activated</p>
    </div>
  );
}
...
function Tab1() {
  return (
    <div className="box-border content-stretch flex gap-[10px] items-center justify-center pb-[20px] pt-0 px-0 relative shrink-0" data-name="Tab">
      <p className="font-['IBM_Plex_Sans:Regular',_sans-serif] leading-[normal] not-italic relative shrink-0 text-[#161616] text-[14px] text-nowrap whitespace-pre">Accepted</p>
    </div>
  );
}
...
function Frame1152() {
  return (
    <div className="content-stretch flex font-['IBM_Plex_Sans:Regular',_sans-serif] gap-[20px] items-start leading-[0] not-italic relative shrink-0 text-[#161616] text-[14px] text-nowrap w-full whitespace-pre">
      <p className="leading-[normal] relative shrink-0">
  ...
  return (
    <div className="content-stretch flex flex-col gap-[5px] items-start relative shrink-0 w-full">
      <p className="font-['IBM_Plex_Sans:Regular',_sans-serif] leading-[normal] min-w-full not-italic relative shrink-0 text-[#161616] text-[14px] w-[min-content]">
        <span>{`Part No: `}</span>
        <span className="font-['IBM_Plex_Sans:Light',_sans-serif]">WH340</span>
      </p>
      <p className="font-['IBM_Plex_Sans:Regular',_sans-serif] leading-[normal] min-w-full not-italic relative shrink-0 text-[#161616] text-[14px] w-[min-content]">{`Code: `}</p>
      <p className="font-['IBM_Plex_Sans:Regular',_sans-serif] leading-[normal] min-w-full not-italic relative shrink-0 text-[#161616] text-[14px] w-[min-content]">
        <span>{`Part: `}</span>
        <span className="font-['IBM_Plex_Sans:Light',_sans-serif]">{`test package part	`}</span>
      </p>
      <p className="font-['IBM_Plex_Sans:Regular',_sans-serif] leading-[normal] min-w-full not-italic relative shrink-0 text-[#161616] text-[14px] w-[min-content]">
        <span>{`Physical Location: `}</span>
        <span className="font-['IBM_Plex_Sans:Light',_sans-serif]">BMW PARTS</span>
      </p>
      <Frame1151 />
      <Frame1152 />
    </div>
...
function PartCard() {
  return (
    <div className="absolute bg-[#f4f4f4] box-border content-stretch flex gap-[20px] items-center left-[20px] p-[16px] top-[328px] w-[390px]" data-name="Part Card">
      <Frame19 />
    </div>
  );
}
...
export default function PartsRelocation() {
  return (

import svgPaths from "./svg-ujjvnuppce";
  ...
  return (
    <div className="bg-[#f4f4f4] h-[40px] relative shrink-0 w-[390px]" data-name="Searchbar">
      <div className="box-border content-stretch flex gap-[20px] h-[40px] items-center overflow-clip px-[20px] py-[10px] relative rounded-[inherit] w-[390px]">
        <Search1 />
        <p className="font-['IBM_Plex_Sans:Regular',_sans-serif] leading-[normal] not-italic relative shrink-0 text-[#63646a] text-[14px] text-nowrap whitespace-pre">wh340</p>
      </div>
...
function Frame20() {
  return (
    <div className="basis-0 content-stretch flex flex-col font-['IBM_Plex_Sans:Regular',_sans-serif] gap-[5px] grow items-start leading-[0] min-h-px min-w-px not-italic relative shrink-0 text-[#161616] text-[14px]">
      ...
      <p className="leading-[normal] relative shrink-0 w-full">
        <span>{`Current Avail: `}</span>
        <span className="font-['IBM_Plex_Sans:Light',_sans-serif] not-italic">22</span>
      </p>
    </div>
  );
}
...
function Frame21() {
  return (
    <div className="basis-0 content-stretch flex flex-col font-['IBM_Plex_Sans:Regular',_sans-serif] gap-[5px] grow items-start leading-[0] min-h-px min-w-px not-italic relative shrink-0 text-[#161616] text-[14px]">
      ...
      <p className="leading-[normal] relative shrink-0 w-full">
        <span>{`Shelf Addres: `}</span>
        <span className="font-['IBM_Plex_Sans:Light',_sans-serif] not-italic">B6</span>
      </p>
      <p className="leading-[normal] relative shrink-0 w-full">
        <span>{`Current Avail: `}</span>
        <span className="font-['IBM_Plex_Sans:Light',_sans-serif] not-italic">34</span>
      </p>
    </div>
  );
}
...
function Frame1145() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] h-[546px] items-start overflow-clip relative shrink-0">
      <PartCard />
      <PartCard1 />
      <PartCard2 />
      <PartCard3 />
...
export default function SelectParts2() {
  return (
    <div className="bg-white relative size-full" data-name="Select Parts 2">
      <StatusBar />
      <HomeBar />
      <Frame1144 />
      <BottomBar />
